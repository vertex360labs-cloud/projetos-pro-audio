...
A interface trabalha com resolução de até **32-bit/192 kHz**, oferecendo uma plataforma atual para gravação e reprodução em alta resolução. A Flex-10 também acompanha o **Harrison Mixbus 12**, DAW que leva para o ambiente digital uma abordagem de mixagem inspirada em console.

A combinação faz sentido para quem deseja construir um fluxo com identidade Harrison desde a entrada até a mixagem, embora a interface possa naturalmente ser utilizada com outras DAWs compatíveis.
...
A Harrison Flex-10 está em fase de lançamento e pré-venda. O Projetos Pro Audio pode ajudar a avaliar a compatibilidade com seus monitores, pré-amplificadores ADAT, outboards, instrumentos e software antes da definição do sistema.
